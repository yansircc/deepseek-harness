...
export const BROWSER_COMPANION_CONTRACT = 'dsh-chrome/browser-companion@2' as const
...
export const BROWSER_COMPANION_PROBE_KIND = 'dsh-chrome/browser-companion-probe' as const
...
export const BROWSER_COMPANION_WAKE_KIND = 'dsh-chrome/browser-companion-wake' as const
