...
| [`tool-list-models/`](tool-list-models/README.md) | Exposes the live provider/model catalog to the model | registers on `ctx.tools` |
...
| [`llm-grok/`](llm-grok/README.md) | Grok subscription adapter | registers on `ctx.llm` |
