...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-schedule ScheduleDock id \'schedule\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace-git WorkspaceGitChip id \'workspace-git\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-stats StatsDisplayRow id \'stats-display\'',
      'client-ui-theme AppearanceRow id \'appearance\'',
      'client-ui-workspace-git GitDisplayRow id \'git-display\'',
    ],
    replaceRisk: 'none',
