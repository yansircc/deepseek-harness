...
| [`ui-workspace-git/`](ui-workspace-git/README.md) | Presents session-header workspace Git chrome and its display toggles. |
| [`ui-stats/`](ui-stats/README.md) | Presents the composer stats line and its display toggles. |
