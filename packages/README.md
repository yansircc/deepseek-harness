...
| [`chrome/`](chrome/README.md) | Signed-in Chrome capability family and authored Manifest V3 connector artifact | Product — stable API |
...
| [`chrome/`](chrome/README.md) | Chrome automation capability family: executable protocol, Service Definition, and local connector provider | Product — stable API |
...
| [`chrome/`](chrome/README.md) | Chrome automation capability family: protocol, Service Definition, local provider, authored extension, tool Consumer, and Web adapter | Product — stable API |
