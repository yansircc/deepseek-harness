...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ResolveChildAgentOptionsInput: 'subagent.md',
  ResolveDelegationRouteInput: 'subagent.md',
  SubagentRouteParameters: 'subagent.md',
  ...
  WorkspaceGitSample: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ChromeProvider: 'provider implementation contract is owned by packages/chrome/chrome/README.md',
  ChromeCommand: 'browser command union is owned by packages/chrome/chrome-protocol/README.md',
  ChromeJsonValue: 'browser JSON result union is owned by packages/chrome/chrome-protocol/README.md',
  ChromeHealth: 'browser health payload is owned by packages/chrome/chrome-protocol/README.md',
