...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/chrome/chrome-local-web': { kind: 'none', reason: 'Host Web status/download adapter; it registers no model-facing context.' },
  'packages/chrome/chrome-local': { kind: 'indirect', reason: 'Provider implementation; dsh-tool-chrome owns model schemas and rendering.' },
  'packages/chrome/chrome-protocol': { kind: 'none', reason: 'Protocol vocabulary; Consumers own every model-visible projection.' },
  'packages/chrome/chrome': { kind: 'indirect', reason: 'Service Definition; dsh-tool-chrome owns model schemas and rendering.' },
  ...
  'packages/client/ui-stats': { kind: 'none', reason: 'Browser-side conversation stats chrome; registers nothing model-facing.' },
  ...
  'packages/client/ui-zeroy': { kind: 'none', reason: 'Browser-side settings card; tool-zeroy owns every model-facing effect.' },
  ...
  'packages/client/ui-schedule': { kind: 'none', reason: 'Browser-side reminder dock; dsh-schedule owns the model-facing schedule tools.' },
  ...
  'packages/bundle/fork-base': { kind: 'indirect', reason: 'The fork Host tool layer is a patch-list carrier; each inserted row\'s package owns its model-facing behavior.' },
  'packages/bundle/fork-web': { kind: 'indirect', reason: 'The fork Web layer is a patch-list carrier; Schedule and time-context own model-facing effects, while UI rows register none.' },
  ...
  'packages/session/session-tool-stats': { kind: 'none', reason: 'The sessionToolStats unit folds already-logged tool pairs into a client-facing read model and registers nothing model-facing.' },
  ...
  'packages/workspace/workspace-git': { kind: 'none', reason: 'The Host cwd git sample is never written to a session log, prompt, or tool result.' },
