...
flowchart TD
  ...
  subgraph group_subagent["packages/subagent"]
    ...
    pkg_subagent_cursor["subagent-cursor"]
  ...
  subgraph group_chrome["packages/chrome"]
    pkg_chrome["chrome"]
    pkg_chrome_extension["chrome-extension"]
    pkg_chrome_local["chrome-local"]
    pkg_chrome_local_web["chrome-local-web"]
    pkg_chrome_protocol["chrome-protocol"]
    pkg_tool_chrome["tool-chrome"]
  end
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_chrome["client-ui-chrome"]
    ...
    pkg_client_ui_stats["client-ui-stats"]
    ...
    pkg_client_ui_workspace_git["client-ui-workspace-git"]
    pkg_client_ui_zeroy["client-ui-zeroy"]
  ...
  pkg_chrome_extension --> pkg_invariants
  ...
  pkg_chrome --> pkg_agent
  pkg_chrome --> pkg_brand
  pkg_chrome --> pkg_chrome_protocol
  pkg_chrome --> pkg_invariants
  ...
  pkg_chrome_local --> pkg_agent
  pkg_chrome_local --> pkg_chrome
  pkg_chrome_local --> pkg_chrome_protocol
  pkg_chrome_local --> pkg_credentials
  ...
  pkg_tool_list_models --> pkg_invariants
  pkg_tool_list_models --> pkg_llm
  pkg_tool_list_models --> pkg_tools
  ...
  pkg_tool_chrome --> pkg_agent
  pkg_tool_chrome --> pkg_chrome
  pkg_tool_chrome --> pkg_chrome_protocol
  pkg_tool_chrome --> pkg_invariants
  pkg_tool_chrome --> pkg_tools
  ...
  pkg_tool_zeroy --> pkg_agent
  pkg_tool_zeroy --> pkg_credentials
  pkg_tool_zeroy --> pkg_host_webserver
  pkg_tool_zeroy --> pkg_invariants
  pkg_tool_zeroy --> pkg_session
  pkg_tool_zeroy --> pkg_settings
  pkg_tool_zeroy --> pkg_system_prompt
  pkg_tool_zeroy --> pkg_tools
  ...
  pkg_subagent_cursor --> pkg_agent
  pkg_subagent_cursor --> pkg_invariants
  pkg_subagent_cursor --> pkg_llm
  pkg_subagent_cursor --> pkg_session
  pkg_subagent_cursor --> pkg_subagent
  pkg_subagent_cursor --> pkg_subprocess
  pkg_subagent_cursor --> pkg_timeout
  ...
  pkg_subagent_route_policy --> pkg_agent
  pkg_subagent_route_policy --> pkg_invariants
  pkg_subagent_route_policy --> pkg_llm
  pkg_subagent_route_policy --> pkg_subagent
  ...
  pkg_client_ui_chrome --> pkg_api_remotes
  pkg_client_ui_chrome --> pkg_client_connection
  pkg_client_ui_chrome --> pkg_client_locale
  pkg_client_ui_chrome --> pkg_client_runtime
  pkg_client_ui_chrome --> pkg_client_ui_settings
  pkg_client_ui_chrome --> pkg_client_ui_settings_plugins
  pkg_client_ui_chrome --> pkg_invariants
  ...
  pkg_client_ui_zeroy --> pkg_api_remotes
  pkg_client_ui_zeroy --> pkg_client_connection
  pkg_client_ui_zeroy --> pkg_client_locale
  pkg_client_ui_zeroy --> pkg_client_runtime
  pkg_client_ui_zeroy --> pkg_client_ui_settings
  pkg_client_ui_zeroy --> pkg_client_ui_settings_plugins
  pkg_client_ui_zeroy --> pkg_invariants
  ...
  pkg_client_ui_stats --> pkg_client_locale
  pkg_client_ui_stats --> pkg_client_runtime
  pkg_client_ui_stats --> pkg_client_ui_conversation
  pkg_client_ui_stats --> pkg_client_ui_settings
  pkg_client_ui_stats --> pkg_invariants
  pkg_client_ui_stats --> pkg_session_stats
  pkg_client_ui_stats --> pkg_session_tool_stats
  pkg_client_ui_stats --> pkg_settings
  pkg_client_ui_stats --> pkg_token_meter
  ...
  pkg_client_ui_workspace_git --> pkg_client_locale
  pkg_client_ui_workspace_git --> pkg_client_runtime
  pkg_client_ui_workspace_git --> pkg_client_ui_conversation
  pkg_client_ui_workspace_git --> pkg_client_ui_settings
  pkg_client_ui_workspace_git --> pkg_invariants
  pkg_client_ui_workspace_git --> pkg_settings
...
| [`chrome-extension`](../packages/chrome/chrome-extension) | `chrome` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`chrome-protocol`](../packages/chrome/chrome-protocol) | `chrome` | [`brand`](../packages/util/brand) |
...
| [`workspace-git`](../packages/workspace/workspace-git) | `workspace` | [`invariants`](../packages/runtime-diagnostics/invariants), [`typert-protocol`](../packages/typert/protocol) |
...
| [`chrome`](../packages/chrome/chrome) | `chrome` | [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`chrome-protocol`](../packages/chrome/chrome-protocol), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`tool-list-models`](../packages/llm/tool-list-models) | `llm` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`tools`](../packages/core/tools) |
...
| [`tool-chrome`](../packages/chrome/tool-chrome) | `chrome` | [`agent`](../packages/core/agent), [`chrome`](../packages/chrome/chrome), [`chrome-protocol`](../packages/chrome/chrome-protocol), [`invariants`](../packages/runtime-diagnostics/invariants), [`tools`](../packages/core/tools) |
...
| [`tool-zeroy`](../packages/extensions/tool-zeroy) | `extensions` | [`agent`](../packages/core/agent), [`credentials`](../packages/credentials/credentials), [`host-webserver`](../packages/host/webserver), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`settings`](../packages/settings/settings), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
...
| [`subagent-cursor`](../packages/subagent/subagent-cursor) | `subagent` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`subprocess`](../packages/subprocess/subprocess), [`timeout`](../packages/util/timeout) |
...
| [`subagent-route-policy`](../packages/subagent/subagent-route-policy) | `subagent` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`subagent`](../packages/subagent/subagent) |
...
| [`client-ui-chrome`](../packages/client/ui-chrome) | `client` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-settings-plugins`](../packages/client/ui-settings-plugins), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-zeroy`](../packages/client/ui-zeroy) | `client` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-settings-plugins`](../packages/client/ui-settings-plugins), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-stats`](../packages/client/ui-stats) | `client` | [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-settings`](../packages/client/ui-settings), [`invariants`](../packages/runtime-diagnostics/invariants), [`session-stats`](../packages/session/session-stats), [`session-tool-stats`](../packages/session/session-tool-stats), [`settings`](../packages/settings/settings), [`token-meter`](../packages/llm/token-meter) |
...
| [`client-ui-workspace-git`](../packages/client/ui-workspace-git) | `client` | [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-settings`](../packages/client/ui-settings), [`invariants`](../packages/runtime-diagnostics/invariants), [`settings`](../packages/settings/settings) |
