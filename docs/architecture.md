...
[`dsh-base`](../packages/bundle/base/README.md) is the first layer of every profile: model adapters, tools, persistence, sandbox and approval policy, settings, credentials, telemetry. [`dsh-fork-base`](../packages/bundle/fork-base/README.md) adds this fork's Host tools (list-models, zeroY, Chrome). [`dsh-web-app`](../packages/bundle/web-app/README.md) adds the browser application; [`dsh-fork-web`](../packages/bundle/fork-web/README.md) adds this fork's Schedule, workspace-git, stats, and extension UI rows. [`dsh-headless`](../packages/bundle/headless/README.md) adds a one-shot runner with no server at all.
