...
依赖于：`ToolKind`（`@agentclientprotocol/sdk`）

来源：[`packages/subagent/subagent-cursor/src/index.ts:42`](../packages/subagent/subagent-cursor/src/index.ts)
...
来源：[`packages/extensions/tool-chrome/src/config.ts:10`](../packages/extensions/tool-chrome/src/config.ts)
...
来源：[`packages/extensions/tool-zeroy/src/config.ts:10`](../packages/extensions/tool-zeroy/src/config.ts)
...
- `@deepseek-ai/dsh-client-ui-stats`（[`packages/client/ui-stats/src/index.ts`](../packages/client/ui-stats/src/index.ts)）
...
- `@deepseek-ai/dsh-session-tool-stats` — 需要 `sessionProjections`（[`packages/session/session-tool-stats/src/index.ts`](../packages/session/session-tool-stats/src/index.ts)）
...
- `@deepseek-ai/dsh-subagent-route-policy`（[`packages/subagent/subagent-route-policy/src/index.ts`](../packages/subagent/subagent-route-policy/src/index.ts)）
...
- `@deepseek-ai/dsh-tool-list-models` — 需要 `tools` · `llm`（[`packages/llm/tool-list-models/src/index.ts`](../packages/llm/tool-list-models/src/index.ts)）
...
- `@deepseek-ai/dsh-fork-base`（[`packages/bundle/fork-base/src/index.ts`](../packages/bundle/fork-base/src/index.ts)）
- `@deepseek-ai/dsh-fork-web`（[`packages/bundle/fork-web/src/index.ts`](../packages/bundle/fork-web/src/index.ts)）
